...
const Authenticate = ({ variables }) => {
  ...
  return (
    <Box sx={{ width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        {loginn===true?<Login variables={{ username1, setUsername1, password1, setPassword1, seeLoginPassword, setSeeLoginPassword, loginSuccess, setLoginSuccess, handleUsernameChange1, handlePasswordChange1, handleSubmit1, setLogin }} />:<Signup variables={{ setLogin, handleName2, handleUsername2, handlePassword2, handleCpassword2, name2, username2, password2, cpassword2, seeSignup, setSeeSignup, seeSignup2, setSeeSignup2, handleSubmit2 }} />}
    </Box>
  )
}
