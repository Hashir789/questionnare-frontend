...
const Question = ({ variables }) => {
  ...
  return (
    <Box sx={{ width: '100vw' }}>
      ...
      <QuestionSection variables={{ question, setQuestion, image, setImage, data, tempData, setTempData, selectedValue1, handleRadioChange1, selectedValue2, handleRadioChange2, selectedValue3, handleRadioChange3, selectedValue4, handleRadioChange4, updateImage, user, setData, grade, setGrade, end, useEnd }}/>
    </Box>
  )
}
